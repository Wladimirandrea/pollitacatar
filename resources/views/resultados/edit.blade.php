         ...
         <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="resultado1" value="{{ $resultado->resultado1 }}" class="form-control" placeholder="Name">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="resultado2" value="{{ $resultado->resultado2 }}" class="form-control" placeholder="Name">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="resultado3" value="{{ $resultado->resultado3 }}" class="form-control" placeholder="Name">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="resultado4" value="{{ $resultado->resultado4 }}" class="form-control" placeholder="Name">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="resultado5" value="{{ $resultado->resultado5 }}" class="form-control" placeholder="Name">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="resultado6" value="{{ $resultado->resultado6 }}" class="form-control" placeholder="Name">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="resultado7" value="{{ $resultado->resultado7 }}" class="form-control" placeholder="Name">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="resultado8" value="{{ $resultado->resultado8 }}" class="form-control" placeholder="Name">
